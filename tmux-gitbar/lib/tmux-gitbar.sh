...
# Can be redefined here, or preferably in tmux-gitbar.conf
BRANCH_FMT="#[fg=colour11,bold]"
UPSTREAM_FMT="#[fg=colour15,nobold]"
REMOTE_FMT=""
AHEAD_FMT="#[fg=green,nobold]"
BEHIND_FMT="#[fg=#ffaaaa,nobold]"
CLEAN_FMT="#[fg=green,bold]"
STAGED_FMT="#[fg=colour2,bold]"
CONFLICTS_FMT="#[fg=red,bold]"
CHANGED_FMT="#[fg=#ffbb99,bold]"
STASHED_FMT="#[fg=blue,bold]"
UNTRACKED_FMT="#[fg=colour174,bold]"
RESET_FMT="#[fg=colour15,nobold]"
...
replace_branch_symbols() {
  ...
  s1="${1//_AHEAD_/${AHEAD_FMT}${AHEAD_SYMBOL}}"
  s2="${s1//_BEHIND_/${BEHIND_FMT}${BEHIND_SYMBOL}}"
