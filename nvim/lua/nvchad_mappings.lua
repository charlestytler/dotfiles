...
map("n", "<leader>un", "<cmd>set nu!<CR>", { desc = "UI toggle line number" })
...
map("n", "<leader>gb", "<cmd>Telescope git_branch<CR>", { desc = "git branch" })
map("n", "<leader>gt", "<cmd>Telescope git_branch<CR>", { desc = "git stash" })
